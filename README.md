...
A RESTful task management backend focused on secure API design, authentication, task management, and interactive API documentation.
...
- 📋 Developed complete CRUD APIs for:
  ...
  - Updating tasks
  - Deleting tasks
- 📚 Integrated **Swagger/OpenAPI** for interactive API documentation and testing
- 🚀 Deployed the backend for production access

### 🛠️ Backend Stack

`Node.js` · `Express.js` · `MongoDB` · `Mongoose` · `JWT` · `Swagger/OpenAPI` · `REST APIs`
...
**Node.js · Express.js · REST APIs · JWT Authentication · WebSockets · Swagger/OpenAPI**
...
**Docker · AWS · Linux · Git · GitHub · Postman**
...
<p align="center">
  ...
  <a href="mailto:ankitanand2106@gmail.com">
    <img src="https://img.shields.io/badge/-000000?style=for-the-badge&logo=gmail&logoColor=white" alt="Gmail"/>
  </a>
</p>
...
- 🤖 Built full-stack applications with real authentication (**JWT + bcrypt**), real-time features (**WebSockets**), and third-party API integration (**OpenAI**).
- 🔐 Brought security-first thinking into backend development from my experience as an **Information Security Trainee at Flipkart** — I build APIs that validate input and don't trust the client.
